<template>
  <main
    @click="openChat"
    class="w-full active:scale-90 duration-300 mb-3 flex justify-between items-center border-2 rounded-xl border-secondary py-2 px-3"
  >
    <div class="text-gray-50 flex justify-between items-start gap-5">
      ...
      <div
        class="text-gray-50 p-5 rounded-lg bg-blue-600"
